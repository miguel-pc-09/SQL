/*
TRIGGERS ->"Es un disparador", Son insctruciones que se ejecutan autoamticamente, cuando ocurren eventos en la tabla,
es decir no son consultas que nosotros lancemos si no que nosotros programamos un evento que queremos que ocurra 
cuando pase algo en una tabla concreta.
*/
